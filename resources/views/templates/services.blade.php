        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                    <div class="services__pic">
                        <img src="{{ asset('images/services/service-1.png') }}" alt="marketing illustration"
                            class="img-fluid" />
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-start">
                    <div class="services__pic">
                        <img src="{{ asset('images/services/service-2.png') }}" alt="web development illustration"
                            class="img-fluid" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 services mt-4 text-end">
                    <div class="services__pic">
                        <img src="{{ asset('images/services/service-3.png') }}" alt="cloud hosting illustration"
                            class="img-fluid" />
                    </div>
                </div>
            </div>
