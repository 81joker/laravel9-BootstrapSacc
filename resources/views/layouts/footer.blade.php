...
<footer class="footer">
    <div class="container">
        <div class="row">
            <!-- CONETNT FOR THE MOBILE NUMBER -->
            <div class="col-md-4 contact-box pt-1 d-lg-flex d-md-block d-flex">
                ...
                <div class="contact-box__info">
                    <a href="" class="contact-box__info--title">+43 06606180228</a>
            ...
            <div class="col-md-4 contact-box pt-1 d-lg-flex d-md-block d-flex">
                ...
                <div class="contact-box__info">
                    <a href="mailto:nehad.al.timimi@gmail.com"
                        class="contact-box__info--title">nehad.al.timimi@gmail.com</a>
            ...
            <div class="col-md-4 contact-box pt-1 d-lg-flex d-md-block d-flex">
                ...
                <div class="contact-box__info">
                    <a href="" class="contact-box__info--title">Vienna,Austria</a>
                    <p class="contact-box__info--subtitle">Floridsdorf 1210,vienna</p>
                </div>
            </div>
        </div>
    </div>

    <!-- START THE SOCIAL MEDIA CONETNT -->
    <div class="footer-sm" style="background-color:#212121">
        <div class="container">
            <div class="row py-4 text-center text-white">
                <div class="col-lg-5 col-md-6 mb-4  mb-md-0">
                    contact with us on soical media
                </div>
    ...
    <!-- START THE COPYTIGHT INFO -->
    <div class="footer-bottom py-5">
        <div class="container">
            <div class="row text-center text-white">
                <div class="col-12">
                    <div class="footer-bottom__copyright">
                        &COPY; Copyright 2022 <a href="#">Company</a> | Created by <a href="#"
                            target="_blank">Altimimi</a>
                    </div>
                </div>
            </div>
        </div>
